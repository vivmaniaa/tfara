...
$user =  $run_user['username'];

$allimages = glob('img/*'); // get all file names
foreach($allimages as $file){ // iterate files
  if(is_file($file)){
...
function file_newname($path, $filename){
	...
	if(isset($_POST['class_image_div1'])){$class_image_div1= $_POST['class_image_div1'];}else{$class_image_div1= '';}	if(isset($_POST['class_image_div2'])){$class_image_div2= $_POST['class_image_div2'];}else{$class_image_div2= '';}	if(isset($_POST['class_image_div3'])){$class_image_div3= $_POST['class_image_div3'];}else{$class_image_div3= '';}	if(isset($_POST['class_image_div4'])){$class_image_div4= $_POST['class_image_div4'];}else{$class_image_div4= '';}	if(isset($_POST['class_image_div5'])){$class_image_div5= $_POST['class_image_div5'];}else{$class_image_div5= '';}	if(isset($_POST['class_image_div6'])){$class_image_div6= $_POST['class_image_div6'];}else{$class_image_div6= '';}	if(isset($_POST['class_image_div7'])){$class_image_div7= $_POST['class_image_div7'];}else{$class_image_div7= '';}	if(isset($_POST['class_image_div8'])){$class_image_div8= $_POST['class_image_div8'];}else{$class_image_div8= '';}	if(isset($_POST['class_image_div9'])){$class_image_div9= $_POST['class_image_div9'];}else{$class_image_div9= '';}	if(isset($_POST['class_image_div10'])){$class_image_div10= $_POST['class_image_div10'];}else{$class_image_div10= '';}	
 	...
 	mysql_query("UPDATE preview_data SET date=now(), title='$title', style_o_div1='$style_o_div1', style_o_div2='$style_o_div2', style_o_div3='$style_o_div3', style_o_div4='$style_o_div4', style_o_div5='$style_o_div5', style_o_div6='$style_o_div6', style_o_div7='$style_o_div7', style_o_div8='$style_o_div8', style_o_div9='$style_o_div9', style_o_div10='$style_o_div10', attribute_o_div1='$attribute_o_div1', attribute_o_div2='$attribute_o_div2', attribute_o_div3='$attribute_o_div3', attribute_o_div4='$attribute_o_div4', attribute_o_div5='$attribute_o_div5', attribute_o_div6='$attribute_o_div6', attribute_o_div7='$attribute_o_div7', attribute_o_div8='$attribute_o_div8', attribute_o_div9='$attribute_o_div9', attribute_o_div10='$attribute_o_div10', class_o_div1='$class_o_div1', class_o_div2='$class_o_div2', class_o_div3='$class_o_div3', class_o_div4='$class_o_div4', class_o_div5='$class_o_div5', class_o_div6='$class_o_div6', class_o_div7='$class_o_div7', class_o_div8='$class_o_div8', class_o_div9='$class_o_div9', class_o_div10='$class_o_div10', style_i_div1='$style_i_div1', style_i_div2='$style_i_div2', style_i_div3='$style_i_div3', style_i_div4='$style_i_div4', style_i_div5='$style_i_div5', style_i_div6='$style_i_div6', style_i_div7='$style_i_div7', style_i_div8='$style_i_div8', style_i_div9='$style_i_div9', style_i_div10='$style_i_div10', attribute_i_div1='$attribute_i_div1', attribute_i_div2='$attribute_i_div2', attribute_i_div3='$attribute_i_div3', attribute_i_div4='$attribute_i_div4', attribute_i_div5='$attribute_i_div5', attribute_i_div6='$attribute_i_div6', attribute_i_div7='$attribute_i_div7', attribute_i_div8='$attribute_i_div8', attribute_i_div9='$attribute_i_div9', attribute_i_div10='$attribute_i_div10', class_i_div1='$class_i_div1', class_i_div2='$class_i_div2', class_i_div3='$class_i_div3', class_i_div4='$class_i_div4', class_i_div5='$class_i_div5', class_i_div6='$class_i_div6', class_i_div7='$class_i_div7', class_i_div8='$class_i_div8', class_i_div9='$class_i_div9', class_i_div10='$class_i_div10', text_div1='$text_div1', text_div2='$text_div2', text_div3='$text_div3', text_div4='$text_div4', text_div5='$text_div5', text_div6='$text_div6', text_div7='$text_div7', text_div8='$text_div8', text_div9='$text_div9', text_div10='$text_div10', name_image_div1='$name_image_div1', name_image_div2='$name_image_div2', name_image_div3='$name_image_div3', name_image_div4='$name_image_div4', name_image_div5='$name_image_div5', name_image_div6='$name_image_div6', name_image_div7='$name_image_div7', name_image_div8='$name_image_div8', name_image_div9='$name_image_div9', name_image_div10='$name_image_div10', alt_image_div1='$alt_image_div1', alt_image_div2='$alt_image_div2', alt_image_div3='$alt_image_div3', alt_image_div4='$alt_image_div4', alt_image_div5='$alt_image_div5', alt_image_div6='$alt_image_div6', alt_image_div7='$alt_image_div7', alt_image_div8='$alt_image_div8', alt_image_div9='$alt_image_div9', alt_image_div10='$alt_image_div10', attribute_image_div1='$attribute_image_div1', attribute_image_div2='$attribute_image_div2', attribute_image_div3='$attribute_image_div3', attribute_image_div4='$attribute_image_div4', attribute_image_div5='$attribute_image_div5', attribute_image_div6='$attribute_image_div6', attribute_image_div7='$attribute_image_div7', attribute_image_div8='$attribute_image_div8', attribute_image_div9='$attribute_image_div9', attribute_image_div10='$attribute_image_div10', style_image_div1='$style_image_div1', style_image_div2='$style_image_div2', style_image_div3='$style_image_div3', style_image_div4='$style_image_div4', style_image_div5='$style_image_div5', style_image_div6='$style_image_div6', style_image_div7='$style_image_div7', style_image_div8='$style_image_div8', style_image_div9='$style_image_div9', style_image_div10='$style_image_div10', class_image_div1='$class_image_div1', class_image_div2='$class_image_div2', class_image_div3='$class_image_div3', class_image_div4='$class_image_div4', class_image_div5='$class_image_div5', class_image_div6='$class_image_div6', class_image_div7='$class_image_div7', class_image_div8='$class_image_div8', class_image_div9='$class_image_div9', class_image_div10='$class_image_div10' 
 	WHERE user='$user'");
