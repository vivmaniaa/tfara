...
$user = $c_username;
$sql = "SELECT * FROM preview_data WHERE user='$user'";
...
if($name_image_div1 != "")
	{
		$indiv1_content = '<img '.$attribute_image_div1.'  src="img/'.$name_image_div1.'" alt="'.$alt_image_div1.'"   style="'.$style_image_div1.'" class="'.$class_image_div1.'" ';
	}
else
	{
...
if($name_image_div2 != "")
	{
		$indiv2_content = '<img  '.$attribute_image_div2.' src="img/'.$name_image_div2.'" alt="'.$alt_image_div2.'"   style="'.$style_image_div2.'" class="'.$class_image_div2.'" ';
	}
else
	{
...
if($name_image_div3 != "")
	{
		$indiv3_content = '<img   '.$attribute_image_div3.'  src="img/'.$name_image_div3.'" alt="'.$alt_image_div3.'" style="'.$style_image_div3.'" class="'.$class_image_div3.'" ';
	}
else
	{
...
if($name_image_div4 != "")
	{
		$indiv4_content = '<img  '.$attribute_image_div4.' src="img/'.$name_image_div4.'" alt="'.$alt_image_div4.'"   style="'.$style_image_div4.'" class="'.$class_image_div4.'" ';
	}
else
	{
...
if($name_image_div5 != "")	
	{
		$indiv5_content = '<img  '.$attribute_image_div5.' src="img/'.$name_image_div5.'" alt="'.$alt_image_div5.'"   style="'.$style_image_div5.'" class="'.$class_image_div5.'" ';
	}
else
	{
...
if($name_image_div6 != "")
	{
		$indiv6_content = '<img  '.$attribute_image_div6.' src="img/'.$name_image_div6.'" alt="'.$alt_image_div6.'"   style="'.$style_image_div6.'" class="'.$class_image_div6.'" ';
	}
else
	{
...
if($name_image_div7 != "")
	{
		$indiv7_content = '<img  '.$attribute_image_div7.' src="img/'.$name_image_div7.'" alt="'.$alt_image_div7.'"   style="'.$style_image_div7.'" class="'.$class_image_div7.'" ';
	}
else
	{
...
if($name_image_div8 != "")
	{
		$indiv8_content = '<img  '.$attribute_image_div8.' src="img/'.$name_image_div8.'" alt="'.$alt_image_div8.'"   style="'.$style_image_div8.'" class="'.$class_image_div8.'" ';
	}
else
	{
...
if($name_image_div9 != "")
	{
		$indiv9_content = '<img  '.$attribute_image_div9.' src="img/'.$name_image_div9.'" alt="'.$alt_image_div9.'"   style="'.$style_image_div9.'" class="'.$class_image_div9.'" ';
	}
else
	{
...
if($name_image_div10 != "")	
	{
		$indiv10_content = '<img  '.$attribute_image_div10.' src="img/'.$name_image_div10.'" alt="'.$alt_image_div10.'"   style="'.$style_image_div10.'" class="'.$class_image_div10.'" ';
	}
else
	{
...
$imga= "../../images/v6.jpg"; //images/v6.jpg
$head = "om shanti";
$factnumber = 9999;
$list = '';

$list .= '<div id="div" class="fact wow animated fadeIn dark" style=" position:	relative;  background-image: url(\''.$imga.'\');   background-size: 100% 100%; background-position: center center; font-size: 100%">			                    	    
		<div class="fact_no" style="color:#ffbb00; font-size: 0.7em;">FACT #'.$factnumber.'</div>
		
		<header>
	<div id="outdiv1" '.$attribute_o_div1.' class="'.$class_o_div1.'" style="'.$style_o_div1.'">
		<div id="indiv1" '.$attribute_i_div1.' class="'.$class_i_div1.'" style="'.$style_i_div1.'">
			'.$indiv1_content.'
		</div>
	</div>
	
	<div id="outdiv2" '.$attribute_o_div2.' class="'.$class_o_div2.'" style="'.$style_o_div2.'">
		<div id="indiv2" '.$attribute_i_div2.' class="'.$class_i_div2.'" style="'.$style_i_div2.'">
			'.$indiv2_content.'
		</div>
	</div>

	<div id="outdiv3" '.$attribute_o_div3.' class="'.$class_o_div3.'" style="'.$style_o_div3.'">
		<div id="indiv3" '.$attribute_i_div3.' class="'.$class_i_div3.'" style="'.$style_i_div3.'">
			'.$indiv3_content.'
		</div>
	</div>

	<div id="outdiv4" '.$attribute_o_div4.' class="'.$class_o_div4.'" style="'.$style_o_div4.'">
		<div id="indiv4" '.$attribute_i_div4.' class="'.$class_i_div4.'" style="'.$style_i_div4.'">
			'.$indiv4_content.'
		</div>
	</div>

	<div id="outdiv5" '.$attribute_o_div5.' class="'.$class_o_div5.'" style="'.$style_o_div5.'">
		<div id="indiv5" '.$attribute_i_div5.' class="'.$class_i_div5.'" style="'.$style_i_div5.'">
			'.$indiv5_content.'
		</div>
	</div>
	
	<div id="outdiv6" '.$attribute_o_div6.' class="'.$class_o_div6.'" style="'.$style_o_div6.'">
		<div id="indiv6" '.$attribute_i_div6.' class="'.$class_i_div6.'" style="'.$style_i_div6.'">
			'.$indiv6_content.'
		</div>
	</div>

	<div id="outdiv7" '.$attribute_o_div7.' class="'.$class_o_div7.'" style="'.$style_o_div7.'">
		<div id="indiv7" '.$attribute_i_div7.' class="'.$class_i_div7.'" style="'.$style_i_div7.'">
			'.$indiv7_content.'
		</div>
	</div>

	<div id="outdiv8" '.$attribute_o_div8.' class="'.$class_o_div8.'" style="'.$style_o_div8.'">
		<div id="indiv8" '.$attribute_i_div8.' class="'.$class_i_div8.'" style="'.$style_i_div8.'">
			'.$indiv8_content.'
		</div>
	</div>

	<div id="outdiv9" '.$attribute_o_div9.' class="'.$class_o_div9.'" style="'.$style_o_div9.'">
		<div id="indiv9" '.$attribute_i_div9.' class="'.$class_i_div9.'" style="'.$style_i_div9.'">
			'.$indiv9_content.'
		</div>
	</div>

	<div id="outdiv10" '.$attribute_o_div10.' class="'.$class_o_div10.'" style="'.$style_o_div10.'">
		<div id="indiv10" '.$attribute_i_div10.' class="'.$class_i_div10.'" style="'.$style_i_div10.'">
			'.$indiv10_content.'
		</div>
	</div>
</header>
		...
		<div class="md-col-12 col-xs-12 col-sm-12 bgColorFooter">
			...
			<div class="col-md-6 col-xs-6 col-sm-6 text-left ">
				<div class="factSource">
					<div class="wow animated bounce" data-wow-delay="10s" data-wow-offset="10" data-wow-iteration="3"><span class="st_facebook_hcount" st_url="http://www.testslider.co.nf/post.php?postid=" st_title="'.$head.'"></span>
					</div>
				</div>
			</div>

			<div class="col-md-6 col-xs-6 col-sm-6 text-right">
				<div class="fb-like" data-href="http://www.testslider.co.nf/post.php?postid=" data-layout="button_count" data-action="like" data-show-faces="false" data-share="true">
				</div>
			</div>
		</div>
...
// 	$sql3 = "SELECT COUNT(bid) FROM blog WHERE bid >= $idno";
